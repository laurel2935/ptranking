...
class AutoTreeDataSetting(DataSetting):
    """
    ...
    def __init__(self, debug=False, data_id=None, dir_data=None, tree_data_json=None):
        super(AutoTreeDataSetting, self).__init__(debug=debug, data_id=data_id, dir_data=dir_data, data_json=tree_data_json)
...
class AutoTreeEvalSetting(EvalSetting):
    """
    ...
    def __init__(self, debug=False, dir_output=None, tree_eval_json=None):
        super(AutoTreeEvalSetting, self).__init__(debug=debug, dir_output=dir_output, eval_json=tree_eval_json)
    ...
    def default_setting(self):
        ...
        self.eval_dict = dict(debug=self.debug, grid_search=False, dir_output=self.dir_output, do_log=do_log,
                              cutoffs=[1, 3, 5, 10, 20, 50], vali_k = vali_k, do_validation=do_validation,
    ...
    def grid_search(self):
        ...
        self.eval_dict = dict(early_stop_or_boost_round=early_stop_or_boost_round, do_validation=do_validation,
                              cutoffs=cutoffs, vali_k=vali_k, do_log=do_log, mask_label=mask_label)
